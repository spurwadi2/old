...
class Jekyll::Thumbnail < Liquid::Tag
  ...
  def render(context)
    if @source
      ...
      source_path = "assets/img/_fullsize/#{source}"
...
Liquid::Template.register_tag('crop',   Jekyll::Crop)